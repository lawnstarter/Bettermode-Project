...
Your first service sets the baseline for everything that follows. Here's what to do to complete it correctly, protect yourself, and start your record right.
...
Don't assume. What's in the app is your guide.
...
2. Get close enough to capture actual conditions (grass height, any debris, access issues)
3. These photos are timestamped and GPS-tagged — they're your evidence if anything is disputed

This habit protects you on every job, not just the first one. The most common disputes (long grass fees, customer claims the job wasn't done) are resolved by photos. Without them, it's your word against the customer's.
...
- Don't ask the customer to pay you directly or outside the platform. All payments go through LawnStarter.
...
3. If you claimed a long grass fee or reported an issue, confirm those submissions before marking complete — once you mark complete, some options disappear

The mark-complete step is what triggers your payment. Don't rush it, but don't leave it open either.
...
- First 60 Days series — Post 2 of 4
- Links to long grass Field Guide post (task 11) for full detail on the long grass flow
- Source docs: `docs/references/pro-kb/troubleshooting-problems-in-the-field.md`, `docs/references/pro-kb/pro-onboarding-faqs.md`, `docs/dads/2026-02-05-problem-flows-for-pros.md` (43.3% first-job cancel rate context)
