...
But it only works if you use it correctly. Here's how.
...
## How to claim the upcharge

The long grass upcharge is requested through the app during the job flow. When you're on-site and have confirmed the conditions:

1. Select the long grass option in the app before you begin
2. Take your before photos
3. Complete the job
4. Submit with documentation

Do not complete the job first and try to claim the upcharge after. The flow is designed for documentation before service, not after.

---

## What to do if a customer disputes the upcharge

Disputes happen. If a customer pushes back on a long grass charge:
...
## Why some Pros avoid the feature
