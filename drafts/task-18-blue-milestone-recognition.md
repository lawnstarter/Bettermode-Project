# Blue Attainment Milestone Recognition — Process + Template
**Task:** 18
**Format:** Process doc + post template
...
Use this when a Pro opts in. Customize the bracket fields.
...
[Name] has been on the platform [X weeks / X months] and [brief detail if they shared it — "completed their first 10 jobs", "stayed consistent through the slow weeks", etc. If you don't have detail, skip this line].

Blue means [Name] now sees available jobs before Silver engaged Pros — the queue works in your favor when your numbers are solid.

If you're still working toward it: [link to Getting to Blue post — task 10].
...
- The goal is recognition, not a leaderboard — this isn't competitive

---

## Frequency and Tracking

- Post recognition within 48 hours of a Pro opting in
- Keep a simple running log (a comment thread, a note, whatever works) so you don't lose track of opt-ins
- If volume grows past 5–10 per month, consider a monthly "New Blues" roundup post instead of individual posts

---

## PUBLISHING NOTES

- Pin the opt-in prompt alongside the First 60 Days series when that goes live
- Link recognition posts to `drafts/task-10-getting-to-blue.md` once published
- No automated tracking needed for now — manual is fine at current community size
