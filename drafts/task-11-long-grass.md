...
GPS ping on arrival also matters — it confirms you were actually at the property at that time. Make sure location services are on.

Without photos, it's your word against the customer's. With photos, it's documented fact.
...
|---|---|
| Grass 9–15 inches | Photo → report in app → complete job → get paid |
| Grass over 15 inches | Photo → submit quote → wait for acceptance → then complete |
| Customer declines quote | Skip the job — no metric hit |
| Mowed within 30 days | Option won't appear — document and contact support |
| Forgot to report before marking complete | Too late for that job — don't let it happen next time |
...
- Field Guide series — no need to pin, but tag consistently with other Field Guide posts
- Source docs: `docs/references/pro-kb/how-to-report-long-grass.md`, `docs/references/pro-kb/pro-onboarding-faqs.md`, `data/zendesk-new-pro-baseline.md`
