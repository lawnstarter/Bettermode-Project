# DRAFT: Your Tier, Your Rewards
**Task:** 17
**Format:** Pinned post (companion to the metrics post)
**Status:** Draft — ready for review before publishing
**References:** [Understanding Your Performance Metrics](https://community.lawnstarter.com/pro-academy/post/understanding-your-performance-metrics-bdOkZchKSjxDJwo)
...
9. Intro (nearby)
10. Bronze (nearby)
11. Intro (farther out)
12. Bronze (farther out)
13. Disengaged
14. Red (last — and no text alerts)

If you're Red, you're seeing jobs after everyone else has already had a shot at them. That's why tier recovery is hard — fewer jobs means fewer chances to build your numbers back up.
...
- Trip fees kick in at Silver / Blue and scale up from there
- Auto-placement and tip matching are Platinum/Gold benefits worth working toward

For how to actually move your numbers, see the [metrics post](https://community.lawnstarter.com/pro-academy/post/understanding-your-performance-metrics-bdOkZchKSjxDJwo).
