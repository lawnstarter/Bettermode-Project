...
| Situation | Trip fee? |
|---|---|
| GPS was off when you arrived | No |
| Customer messaged you in advance (any notice counts) | No |
| You arrived outside the service window or early without approval | No |
| You've hit your quarterly limit for that property | No |
| You rescheduled instead of skipping | No |

If you think you should have gotten one and didn't, check all of the above before contacting support. Nine times out of ten, one of these applies.
...
Your cancellation rate is unaffected. That metric only counts cancellations you caused.
...
|---|---|
| Locked gate, no prior notice, GPS on | Take photos → message customer → skip in app → trip fee auto-issued |
| Customer messaged you before you left | Prior notice = no trip fee. Skip the job normally. |
| Dog in yard blocking access | Same as locked gate — document, skip, report via Other |
| Partial access (front yard only) | Complete what you can, report obstruction, get paid for partial |
| GPS was off when you arrived | Trip fee won't apply. Note for next time. |
...
- Pairs with Task 12 (Customer Cancels) — consider publishing together or linking between them
- Source docs: `docs/references/pro-kb/troubleshooting-problems-in-the-field.md`, `docs/references/pro-kb/tiers-metrics-and-rewards-faq.md`, `docs/references/pro-journey/performance-mgmt.md`, `docs/references/pro-kb/guidelines-navigating-account-health-and-challenges.md`
