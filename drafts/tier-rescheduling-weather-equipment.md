...
Weather and equipment exceptions, when properly reported, are treated differently from voluntary cancellations. The key is *how* you handle it:

- Reschedule through the app = documented reason
- Drop without contact or documentation = treated like a standard drop

The difference between a protected reschedule and a tier hit is mostly in the process.
